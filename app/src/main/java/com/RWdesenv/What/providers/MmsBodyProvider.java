...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.RWdesenv.provider.securesms.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("com.RWdesenv.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }

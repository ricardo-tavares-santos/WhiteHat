...
import com.RWdesenv.What.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.RWdesenv.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("com.RWdesenv.provider.securesms", "part/*/#", SINGLE_ROW);
  }

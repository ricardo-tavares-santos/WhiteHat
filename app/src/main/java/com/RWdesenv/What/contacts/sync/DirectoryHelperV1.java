...
import com.RWdesenv.What.crypto.SessionUtil;
...
import com.RWdesenv.What.sms.IncomingJoinedMessage;
...
class DirectoryHelperV1 {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("com.RWdesenv.What");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "com.RWdesenv.What");

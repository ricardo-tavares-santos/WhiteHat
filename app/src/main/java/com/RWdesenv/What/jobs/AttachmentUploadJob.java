...
import com.RWdesenv.What.blurhash.BlurHashEncoder;
...
public final class AttachmentUploadJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<AttachmentUploadJob> {
    @Override
    public @NonNull AttachmentUploadJob create(@NonNull Parameters parameters, @NonNull com.RWdesenv.What.jobmanager.Data data) {

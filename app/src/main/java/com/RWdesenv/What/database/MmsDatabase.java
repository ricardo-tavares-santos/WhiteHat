...
import com.RWdesenv.What.attachments.MmsNotificationAttachment;
import com.RWdesenv.What.contactshare.Contact;
import com.RWdesenv.What.database.documents.IdentityKeyMismatch;
import com.RWdesenv.What.database.documents.IdentityKeyMismatchList;
import com.RWdesenv.What.database.documents.NetworkFailure;
import com.RWdesenv.What.database.documents.NetworkFailureList;
...
import com.RWdesenv.What.database.model.NotificationMmsMessageRecord;
...
import com.RWdesenv.What.mms.IncomingMediaMessage;
...
import com.RWdesenv.What.revealable.ViewOnceExpirationInfo;
...
import static com.RWdesenv.What.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.RWdesenv.What.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = com.RWdesenv.What.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = com.RWdesenv.What.util.Util.toIsoBytes(transactionId);

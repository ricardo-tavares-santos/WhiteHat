...
public class DatabaseContentProviders {
  ...
  public static class ConversationList extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.RWdesenv.What.database.conversationlist");
  }

  public static class Conversation extends NoopContentProvider {
    private static final String CONTENT_URI_STRING = "content://com.RWdesenv.What.database.conversation/";
  ...
  public static class Attachment extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.RWdesenv.What.database.attachment");
  }

  public static class Sticker extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.RWdesenv.What.database.sticker");
  }

  public static class StickerPack extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://com.RWdesenv.What.database.stickerpack");
  }
